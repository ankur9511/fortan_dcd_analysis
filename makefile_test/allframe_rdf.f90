subroutine allrdf_z(aid, t_t_outname, O_ID, HO_ID1, HO_ID2, OH_ID, &
        & HOH_ID1, HOH_ID2, &
      ...
      & " = ",nbincrdf,"x",lensolv2drdfarr
        ...
        call cpu_time(T2)
        !!print *, outname
        open(199, file=trim(outname)//"progressrdf.txt", &
...
!!
       ...
       ! write(200,FMT=*) -hbox0(2),-hbox0(2)+(nz0-1)*dz,dt,maxdtdynsteps*dt
       ! close(200)
end subroutine allrdf_z

subroutine allrdf(aid,t_t_outname,O_ID,HO_ID1,HO_ID2,OH_ID,HOH_ID1,HOH_ID2,Os_ID,subs_ID,filenames,dt,nfiles,frame,n_O_ID,n_OH_ID,n_Os_ID,n_subs_ID) 
        implicit none
        ...
        print *, SIZE(O_ID)," == ",n_O_ID
        print *, SIZE(OH_ID)," == ",n_OH_ID
        call allrdf_z(aid, t_t_outname, O_ID, HO_ID1, HO_ID2, OH_ID, &
           & HOH_ID1, HOH_ID2, &
           & Os_ID, subs_ID, filenames, dt, frame, &
           & n_O_ID, n_OH_ID, n_Os_ID, n_subs_ID, &
           & nfiles, tot_frame, tot_atom, &
