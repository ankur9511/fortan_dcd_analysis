subroutine alldyn_z( dr_dt_rc, n_dt_rc, &
        ...
        real(4) :: dxt, dyt, dzt, binctobin=0.0, dr2=0.0,zi0,zit, fnskip=10.
        integer :: nxt, nyt, nzt, zref, n, m, m2, i, j, k, i0, it, nskip=10
        ...
        do m = frame+1, frame+1+maxdtsteps*nskip-3*nskip, nskip
         ...
         do i = 0,n_ID-1
           ...
           dr2 = dr0t(0)*dr0t(0)
           dx_dt_2dmsd(:,int((m-frame-1)/fnskip)) = dx_dt_2dmsd(:,int((m-frame-1)/fnskip))+(dr2-K_dt_2dmsd(:,int((m-frame-1)/fnskip)))*flag(:,i)
           dx2_dt_2dmsd(:,int((m-frame-1)/fnskip)) = dx2_dt_2dmsd(:,int((m-frame-1)/fnskip))+(dr2-K_dt_2dmsd(:,int((m-frame-1)/fnskip)))*(dr2-K_dt_2dmsd(:,int((m-frame-1)/fnskip)))*flag(:,i)

           dr2 = dr0t(1)*dr0t(1)
           dy_dt_2dmsd(:,int((m-frame-1)/fnskip)) = dy_dt_2dmsd(:,int((m-frame-1)/fnskip))+(dr2-K_dt_2dmsd(:,int((m-frame-1)/fnskip)))*flag(:,i)
           dy2_dt_2dmsd(:,int((m-frame-1)/fnskip)) = dy2_dt_2dmsd(:,int((m-frame-1)/fnskip))+(dr2-K_dt_2dmsd(:,int((m-frame-1)/fnskip)))*(dr2-K_dt_2dmsd(:,int((m-frame-1)/fnskip)))*flag(:,i)


           dr2 = dot_product(dr0t(0:1),dr0t(0:1))
           dr_dt_2dmsd(:,int((m-frame-1)/fnskip)) = dr_dt_2dmsd(:,int((m-frame-1)/fnskip))+(dr2-K_dt_2dmsd(:,int((m-frame-1)/fnskip)))*flag(:,i)
           dr2_dt_2dmsd(:,int((m-frame-1)/fnskip)) = dr2_dt_2dmsd(:,int((m-frame-1)/fnskip))+(dr2-K_dt_2dmsd(:,int((m-frame-1)/fnskip)))*(dr2-K_dt_2dmsd(:,int((m-frame-1)/fnskip)))*flag(:,i)


           n_dt_2dmsd(:,int((m-frame-1)/fnskip)) = n_dt_2dmsd(:,int((m-frame-1)/fnskip))+1.0*flag(:,i)
           ...
           dr_dt_rc(:,int((m-frame-1)/fnskip)) = dr_dt_rc(:,int((m-frame-1)/fnskip)) + (dr2-K_dt_rc(:,int((m-frame-1)/fnskip)))*flag(:,i)

           dr2_dt_rc(:,int((m-frame-1)/fnskip)) = dr2_dt_rc(:,int((m-frame-1)/fnskip)) + (dr2-K_dt_rc(:,int((m-frame-1)/fnskip)))*(dr2-K_dt_rc(:,int((m-frame-1)/fnskip)))*flag(:,i)

           n_dt_rc(:,int((m-frame-1)/fnskip)) = n_dt_rc(:,int((m-frame-1)/fnskip))+1.0*flag(:,i)
