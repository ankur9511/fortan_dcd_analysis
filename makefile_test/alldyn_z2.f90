subroutine alldyn_z( dr_dt_rc, n_dt_rc, &
        ...
        integer :: nxt, nyt, nzt, zref, n, m, m2, i, j, k, i0, it
        ...
        do m = frame+1, frame+1+maxdtsteps*20-3*20, 20
         !print *, m
         rt(:,:) = 0.0         
         ...
         do i = 0,n_ID-1
           ...
           dr2 = dr0t(0)*dr0t(0)
           dx_dt_2dmsd(:,int((m-frame-1)/20.)) = dx_dt_2dmsd(:,int((m-frame-1)/20.))+(dr2-K_dt_2dmsd(:,int((m-frame-1)/20.)))*flag(:,i)
           dx2_dt_2dmsd(:,int((m-frame-1)/20.)) = dx2_dt_2dmsd(:,int((m-frame-1)/20.))+(dr2-K_dt_2dmsd(:,int((m-frame-1)/20.)))*(dr2-K_dt_2dmsd(:,int((m-frame-1)/20.)))*flag(:,i)

           dr2 = dr0t(1)*dr0t(1)
           dy_dt_2dmsd(:,int((m-frame-1)/20.)) = dy_dt_2dmsd(:,int((m-frame-1)/20.))+(dr2-K_dt_2dmsd(:,int((m-frame-1)/20.)))*flag(:,i)
           dy2_dt_2dmsd(:,int((m-frame-1)/20.)) = dy2_dt_2dmsd(:,int((m-frame-1)/20.))+(dr2-K_dt_2dmsd(:,int((m-frame-1)/20.)))*(dr2-K_dt_2dmsd(:,int((m-frame-1)/20.)))*flag(:,i)


           dr2 = dot_product(dr0t(0:1),dr0t(0:1))
           dr_dt_2dmsd(:,int((m-frame-1)/20.)) = dr_dt_2dmsd(:,int((m-frame-1)/20.))+(dr2-K_dt_2dmsd(:,int((m-frame-1)/20.)))*flag(:,i)
           dr2_dt_2dmsd(:,int((m-frame-1)/20.)) = dr2_dt_2dmsd(:,int((m-frame-1)/20.))+(dr2-K_dt_2dmsd(:,int((m-frame-1)/20.)))*(dr2-K_dt_2dmsd(:,int((m-frame-1)/20.)))*flag(:,i)


           n_dt_2dmsd(:,int((m-frame-1)/20.)) = n_dt_2dmsd(:,int((m-frame-1)/20.))+1.0*flag(:,i)
           ...
           dr_dt_rc(:,int((m-frame-1)/20.)) = dr_dt_rc(:,int((m-frame-1)/20.)) + (dr2-K_dt_rc(:,int((m-frame-1)/20.)))*flag(:,i)

           dr2_dt_rc(:,int((m-frame-1)/20.)) = dr2_dt_rc(:,int((m-frame-1)/20.)) + (dr2-K_dt_rc(:,int((m-frame-1)/20.)))*(dr2-K_dt_rc(:,int((m-frame-1)/20.)))*flag(:,i)

           n_dt_rc(:,int((m-frame-1)/20.)) = n_dt_rc(:,int((m-frame-1)/20.))+1.0*flag(:,i)
        ...
        write(199,FMT=*) "Progress of frames: ", &
                        & int(float(m-frame)/float(maxdtsteps*20)*100), &
                        & "% done ", &
                        & int((T2-T1)/float(m-frame)*float(maxdtsteps*20-m)/60.0), &
                        & " min left", &
                        & int((T2-T1)/float(m-frame)*float(maxdtsteps*20-m)/60.0/60.0), &
                        & " hrs left"
        close(199)
