subroutine xyfdyn_z(aid, t_t_outname, O_ID, HO_ID1, HO_ID2, OH_ID, &
        & HOH_ID1, HOH_ID2, &
        ...
        real(4), dimension(0:nbinsdyn-1,0:maxdtdynsteps-1) :: dx_dt_2dmsd, &
        & dy_dt_2dmsd, n_dt_2dmsd
      ...
      & " = ",nbincrdf,"x",lensolv2drdfarr
        ...
        call xydyn_z(dx_dt_2dmsd, dy_dt_2dmsd, n_dt_2dmsd, &
...
!!
       ...
       ! !dr_dt_rc,n_dt_rc,dr_dt_2dmsd,n_dt_2dmsd,n_dt_RT
        ...
        dx_dt_2dmsd(i,j) = dx_dt_2dmsd(i,j)/max(1.0,n_dt_2dmsd(i,j))
        dy_dt_2dmsd(i,j) = dy_dt_2dmsd(i,j)/max(1.0,n_dt_2dmsd(i,j))
        end do
        end do
...
end subroutine xyfdyn_z

subroutine xyfdyn(aid,t_t_outname,O_ID,HO_ID1,HO_ID2,OH_ID,HOH_ID1,HOH_ID2,Os_ID,subs_ID,filenames,dt,nfiles,frame,n_O_ID,n_OH_ID,n_Os_ID,n_subs_ID) 
        implicit none
        ...
        print *, SIZE(O_ID)," == ",n_O_ID
        print *, SIZE(OH_ID)," == ",n_OH_ID
        call xyfdyn_z(aid, t_t_outname, O_ID, HO_ID1, HO_ID2, OH_ID, &
           & HOH_ID1, HOH_ID2, &
           & Os_ID, subs_ID, filenames, dt, frame, &
           & n_O_ID, n_OH_ID, n_Os_ID, n_subs_ID, &
           & nfiles, tot_frame, tot_atom, &
